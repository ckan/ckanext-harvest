...
Registering ckanext-harvest on PyPI
===================================

ckanext-harvest should be availabe on PyPI as
https://pypi.python.org/pypi/ckanext-harvest. If that link doesn't work, then
...
Releasing a New Version of ckanext-harvest
==========================================

ckanext-harvest is availabe on PyPI as https://pypi.python.org/pypi/ckanext-harvest.
